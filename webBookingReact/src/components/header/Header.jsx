           ...
           {!user && <button className="headerBtn" onClick={handleAuthClick}>Sign In / Register</button>}
            <div className="headerSearch">
              ...
              <div className="headerSearchItem">
                ...
                {openDate && (
                  <div className="date-container" style={{ zIndex: 30 }}>
                    <DateRange
              ...
              <div className="headerSearchItem">
                ...
                <span
                  onClick={() => setOpenDate(false)} // Always close date picker when clicking options
                  className="headerSearchText"
                  style={{ cursor: "default" }}
                >
                  Show Options
                </span>
                <div className="options" style={{ zIndex: openDate ? 9 : 20 }}>
